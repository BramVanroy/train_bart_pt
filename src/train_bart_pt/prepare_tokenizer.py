...
def main():
    ...
    cparser.add_argument("--base_tokenizer_name", default="facebook/bart-base",
                         help="Base tokenizer to start from. We'll reuse the same special tokens and tokenization"
